...
def main():
    ...
    parser.add_argument("--output_dir", default="data/MUTAG/AIDS",
                        help="Output directory for GXL files (default: data/MUTAG/AIDS)")
    parser.add_argument("--collection_file", default="data/MUTAG/AIDS/AIDS_re.xml",
                        help="Output collection XML file (default: data/MUTAG/AIDS/AIDS_re.xml)")
