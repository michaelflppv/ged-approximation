...
GED_EXECUTABLE = os.path.join(script_dir, "../gedlib_/build/main_exec")  # Ensure this path is correct
...
RESULTS_FILE = os.path.join(RESULTS_DIR, "PROTEINS_EXACT_results.xlsx")
