...
def parameter_parser():
    ...
    parser.add_argument("--testing-graphs",
                        nargs="?",
                        default=r"C:\project_data\processed_data\json_pairs\PROTEINS",
                        help="Folder with testing graph pair jsons.")

    # These epochs parameter is no longer used in iteration-based training.
    parser.add_argument("--epochs",
                        type=int,
                        default=5,
                        help="(Deprecated) Number of training epochs. Not used in iteration-based training.")

    parser.add_argument("--iterations",
                        type=int,
                        default=10000,
                        help="Total number of training iterations. Default is 10000.")

    parser.add_argument("--val-interval",
                        type=int,
                        default=100,
                        help="Interval (in iterations) for evaluating on the validation set. Default is 100.")
